...
trait HasSet
{
     ...
     */
    public static function sMisMember(string $key, string $member, string ...$other_members): false|array
    {
     ...
     * @return bool
     */
    public static function sMove(string $src, string $dst, mixed $value): bool
    {
